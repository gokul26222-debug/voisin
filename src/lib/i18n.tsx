...
const translations = {
  fr: {
    ...
    safety_reassurance: "Un petit signe chaque jour. Votre famille est rassurÃ©e.",
    ...
    share: "Je partage",
    share_hint: "Partagez ce que vous aimez",
    share_title: "Que voulez-vous partager ?",
    share_intro: "Choisissez une activité simple. Voisin vous aide à organiser une petite rencontre dans un lieu public.",
    share_french: "Conversation française",
    share_cooking: "Cuisine simple",
    share_gardening: "Jardinage",
    share_sewing: "Couture et réparation",
    share_games: "Jeux de cartes",
    share_continue: "Continuer",
    share_review_title: "Votre première rencontre",
    share_review_info: "Jeudi · 15h00 · Médiathèque · 4 places",
    share_safe_place: "Lieu public uniquement. Voisin vérifie la rencontre avant sa publication.",
    share_publish: "Proposer cette rencontre",
    share_published: "Votre rencontre est prête !",
    share_published_info: "Voisin va la vérifier avant de la proposer aux étudiants.",
    // Settings
    settings: "Réglages",
  ...
  en: {
    ...
    safety_reassurance: "A small sign each day. Your family feels reassured.",
    ...
    share: "I share",
    share_hint: "Share what you enjoy",
    share_title: "What would you like to share?",
    share_intro: "Choose a simple activity. Voisin helps you organise a small meeting in a public place.",
    share_french: "French conversation",
    share_cooking: "Simple cooking",
    share_gardening: "Gardening",
    share_sewing: "Sewing and repairs",
    share_games: "Card games",
    share_continue: "Continue",
    share_review_title: "Your first meeting",
    share_review_info: "Thursday · 3:00 PM · Library · 4 places",
    share_safe_place: "Public place only. Voisin checks the meeting before it is published.",
    share_publish: "Suggest this meeting",
    share_published: "Your meeting is ready!",
    share_published_info: "Voisin will check it before offering it to students.",
    // Settings
    settings: "Settings",
    text_size: "Text size",
    normal: "Normal",
